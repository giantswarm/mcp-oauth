...
```go
// validateAndSanitizeMetadataURL performs DNS resolution and blocks private IPs
...
| Timing attacks on signature comparison | Use library parser (`github.com/go-jose/go-jose/v4`); no bespoke crypto | (delegated) |
